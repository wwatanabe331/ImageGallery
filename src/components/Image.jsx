export default function Image() {
  return (
    <div>
      <a href="./src/Image/favorite-1.jpg">
        <img
          src="./src/Image/favorite-1_th.jpg"
          alt="Small black bird, black claws, long black slender beak, links to larger version of the image"
        />
      </a>

      <a href="./src/Image/favorite-2.jpg">
        <img
          src="./src/Image/favorite-2_th.jpg"
      ...
      <a href="./src/Image/favorite-3.jpg">
        <img
          src="./src/Image/favorite-3_th.jpg"
      ...
      <a href="./src/Image/favorite-4.jpg">
        <img
          src="./src/Image/favorite-4_th.jpg"
